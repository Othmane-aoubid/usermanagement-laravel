                                        ...
                                        <div class="flex items-center" style="justify-content: space-between;">
                                          ...
                                          <div class="flex justify-end">
                                            <div class=" flex gap-2 spaxe-x-2">
                                                <!-- <span class="flex items-center"><a href="" class="px-4 py-2 bg-blue-500 bg-blue-700 text-white rounded-md">Edit</a></span> -->
                                                <form  method="POST" action="{{ route('admin.users.destroy' , $user->id) }}" onsubmit="return confirm('are you sure you want to delete this?')">
                                                    @csrf
                                                    @method('DELETE')
